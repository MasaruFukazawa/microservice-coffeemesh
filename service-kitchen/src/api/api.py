...
from .schemas import (GetKitchenScheduleParameters, GetScheduledOrderSchema,
                      GetScheduledOrdersSchema, ScheduleOrderSchema,
...
class KitchenSchedule(MethodView):
    ...
    def get(self, schedule_id):
        ...
        abort(404, description=f"ID {schedule_id} のスケジュールが見つかりません")
